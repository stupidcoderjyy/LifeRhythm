...
const QString Styles::CYAN_DARK = "#2f4042";
const QString Styles::CYAN = "#4b676a";
const QString Styles::CYAN_BRIGHT = "#61868d";
const QString Styles::GRAY_TEXT_0 = "#C8C8C8";
const QString Styles::TRANSPARENT = "#00000000";
const QString Styles::MAIN_FONT = "Source Han Sans CN Medium";
const int Styles::FONT_SIZE_MEDIUM = 12;